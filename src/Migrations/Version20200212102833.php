 ...
 */
final class Version20200212102833 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chambre ADD statut_assignation_menage SMALLINT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE assignation_menage DROP statut_validation_menage');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE assignation_menage ADD statut_validation_menage SMALLINT DEFAULT NULL');
        $this->addSql('ALTER TABLE chambre DROP statut_assignation_menage');
