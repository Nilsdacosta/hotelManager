 ...
 */
final class Version20200207193315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE option_service (id INT AUTO_INCREMENT NOT NULL, employe_id INT NOT NULL, tva_id INT DEFAULT NULL, nom_option VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, prix_option DOUBLE PRECISION NOT NULL, INDEX IDX_F9698DA71B65292 (employe_id), INDEX IDX_F9698DA74D79775F (tva_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
