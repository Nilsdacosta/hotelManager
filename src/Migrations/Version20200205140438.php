 ...
 */
final class Version20200205140438 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE option_service CHANGE employe_id employe_id INT NOT NULL, CHANGE tva_id tva_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE option_service CHANGE employe_id employe_id INT DEFAULT NULL, CHANGE tva_id tva_id INT DEFAULT NULL');
