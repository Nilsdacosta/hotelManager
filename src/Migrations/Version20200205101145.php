 ...
 */
final class Version20200205101145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE assignation_menage (id INT AUTO_INCREMENT NOT NULL, employe_id INT NOT NULL, option_service_id INT DEFAULT NULL, chambre_id INT DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_A4A3644C1B65292 (employe_id), INDEX IDX_A4A3644C35B1D6 (option_service_id), UNIQUE INDEX UNIQ_A4A3644C9B177F54 (chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, mail VARCHAR(255) DEFAULT NULL, date_de_naissance DATETIME DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employe (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) DEFAULT NULL, poste SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE option_service (id INT AUTO_INCREMENT NOT NULL, employe_id INT NOT NULL, tva_id INT NOT NULL, nom_option VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, prix_option DOUBLE PRECISION NOT NULL, INDEX IDX_F9698DA71B65292 (employe_id), INDEX IDX_F9698DA74D79775F (tva_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, date_entree DATETIME NOT NULL, date_sortie DATETIME NOT NULL, status SMALLINT NOT NULL, carte_bancaire VARCHAR(255) DEFAULT NULL, INDEX IDX_42C8495519EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
