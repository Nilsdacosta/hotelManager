 ...
 */
final class Version20200208181521 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD date_creation DATE NOT NULL, CHANGE date_entree date_entree DATE NOT NULL, CHANGE date_sortie date_sortie DATE NOT NULL, CHANGE carte_bancaire carte_bancaire INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE option_service CHANGE tva_id tva_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reservation DROP date_creation, CHANGE date_entree date_entree DATETIME NOT NULL, CHANGE date_sortie date_sortie DATETIME NOT NULL, CHANGE carte_bancaire carte_bancaire VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
    }
}
